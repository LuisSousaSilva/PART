...
# em dataframe, com todas as cota̵̤es dos fundos alinhadas. ? uma vers?o "alterada" das cota??es que acrescenta dias, de forma alinhar
...
getFI_best <- function(x, Begin_End = "1999-12-31/2017-12-31") {
  ...
  rownames(Fundos.df) <- Fundos.df[, 1]
  Fundos.df <- Fundos.df[, -1]
